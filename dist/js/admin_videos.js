...
function loadVideos() {
    ...
    colRef.get()
        ...
        `)
                ...
                $('#tabla tbody tr').click(function (e) { //EDITAR CATEGORIA
    ...
    $(".btn-guardar-video").on("click", function () {
        try {
            ...
            if (!edit_mode) {
                ...
                uploadVideo($("#input-video").prop("files")[0], colRef, titulo, formatTime(duration), categoriaID);
            }
            else {
...
async function uploadVideo(file, colRef, titulo, duracion, categoriaID) {
