...
<body>
  ...
  <div class="wrapper">
        ...
        <div class="row">
          <div class='col-md-4'>
            <form autocomplete="off">
              ...
              <div class="form-group">
                <label for="link-canal" class="col-form-label">Link Streaming: <i
                    class="fa fa-question-circle text-primary info-tooltip" data-toggle="tooltip" data-placement="top"
                    title="El Link debe ser .m3u8"></i></label>
    ...
    <!-- Modal -->
    <div class="modal fade" id="modalUploadLogo" data-backdrop="static" data-keyboard="false" tabindex="-1"
